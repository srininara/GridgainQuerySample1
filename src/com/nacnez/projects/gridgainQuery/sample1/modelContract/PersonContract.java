package com.nacnez.projects.gridgainQuery.sample1.modelContract;

import java.math.BigDecimal;
import java.util.Date;

import com.nacnez.projects.gridgainQuery.sample1.model.Address;
...
@TargetModel(modelClass=com.nacnez.projects.gridgainQuery.sample1.model.Person.class)
public interface PersonContract extends GenerationContract {
	...
	@Contract(contractClass=com.nacnez.projects.gridgainQuery.sample1.modelContract.AddressContract.class)
